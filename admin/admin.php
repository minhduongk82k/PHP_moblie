...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($_GET['page_layout'] == 'comment' || $_GET['page_layout'] == 'edit_comment' || $_GET['page_layout'] == 'add_comment'){echo 'active';} ?>"><a href="comment.php"><svg class="glyph stroked two messages"><use xlink:href="#stroked-two-messages"/></svg> Quản lý bình luận</a></li>
